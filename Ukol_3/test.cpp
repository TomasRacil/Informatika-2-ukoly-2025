...
protected:
    ...
    void SetUp() override
    {
        ...
        // matIdent = {{1, 0}, {0, 1}}
        matIdent->setValue(0, 0, 1);
        matIdent->setValue(0, 1, 0);
        matIdent->setValue(1, 0, 0);
        matIdent->setValue(1, 1, 1);
    }
...
TEST_F(MatrixOperationsTest, Transpose)
{
    ...
    expected.setValue(0, 1, 3);
    expected.setValue(1, 0, 2);
    expected.setValue(1, 1, 4);
